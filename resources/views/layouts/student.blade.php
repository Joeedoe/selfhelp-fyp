...
{{--
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('student.selfhelp') }}"><i class="fa fa-sticky-note"></i> <span>SelfHelp Center</span></a></li>
        <li><a href="{{ route('student.chats') }}"><i class="fa fa-commenting"></i> <span>Live Help</span></a></li>
        {{-- <li class="treeview">
