...
<head>
  ...
  <title>Chat 2U | Counsellor</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{ route('counsellor.index') }}" class="logo">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ route('counsellor.profile') }}" class="btn btn-default btn-flat">Profile</a>
                </div>
...
{{--
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{ route('counsellor.selfhelp') }}"><i class="fa fa-sticky-note"></i> <span>SelfHelp Center</span></a></li>
        <li><a href="{{ route('counsellor.chats') }}"><i class="fa fa-commenting"></i> <span>Live Help</span></a></li>
        {{-- <li class="treeview">
